...
export const routes: Routes = [
  ...
  // ── Admin ────────────────────────────────────────────────────
  {
    ...
    children: [
      ...
      { path: 'sheikhs',    loadComponent: () => import('./features/admin/sheikhs/sheikhs.component').then(m => m.SheikhsComponent) },
  ...
  // ── Sheikh ───────────────────────────────────────────────────
  {
    ...
    loadComponent: () => import('./features/sheikh/layout/sheikh-layout.component').then(m => m.SheikhLayoutComponent),
    children: [
      { path: '',                    redirectTo: 'queue', pathMatch: 'full' },
      { path: 'queue',               loadComponent: () => import('./features/sheikh/queue/queue.component').then(m => m.QueueComponent) },
      { path: 'scoring/:studentId',  loadComponent: () => import('./features/sheikh/scoring/scoring.component').then(m => m.ScoringComponent) },
    ],
  },
  { path: '**', redirectTo: '' },
];
